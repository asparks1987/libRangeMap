...
- mapper and adapter interfaces
- float mapper
- boolean and missing-value policies
- character and text mappers
- bytes and buffer mappers
- categorical, enum, and vocabulary mappers
- date/time/timestamp/duration mappers
- sequence and nested sequence mappers
- dictionary/map/object schema mappers
- raw pixel data mappers without image-library dependencies
- custom object schemas
- language-neutral compliance fixtures
- per-language quickstart lines for each supported mapper family
