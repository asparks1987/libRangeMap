...
"%JAVA_HOME%\bin\javac.exe" -encoding UTF-8 -d "%ROOT%\wrappers\java\build\classes" "%ROOT%\wrappers\java\src\librangemap\IntegerRangeMapper.java" "%ROOT%\wrappers\java\src\librangemap\MapperSpec.java" "%ROOT%\wrappers\java\src\librangemap\Verify.java"
